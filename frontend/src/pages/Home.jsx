...
export function Home({ onEnterRoom }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-6 px-4 py-16">
      <div className="animate-fade-in-up transition-transform duration-200 hover:scale-105">
        <Logo iconClassName="h-12" textClassName="text-3xl" />
      </div>
      ...
      <Card
        className="w-full max-w-sm text-center animate-fade-in-up transition-transform duration-200 hover:-translate-y-1"
      ...
      <Card
        className="w-full max-w-sm animate-fade-in-up transition-transform duration-200 hover:-translate-y-1"
      ...
      >
        ...
        <form onSubmit={handleJoinRoom} className="flex gap-2">
          <input
            ...
            className="flex-1 px-3 py-2 rounded-lg border border-slate-300 dark:border-slate-600 bg-transparent text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-500"
          />
